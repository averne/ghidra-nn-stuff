...
#pragma once
#include <nn/os/os_rw_lock_common.hpp>
#include <nn/os/os_rw_lock_types.hpp>
#include <nn/os/os_rw_lock_api.hpp>
...
namespace nn::os {
    ...
    class ReadWriteLock {
        ...
        public:
            constexpr explicit ReadWriteLock() : rw_lock{{}, 0, ::nn::os::ReaderWriterLockType::State_Initialized, nullptr, 0, {}, {}} { /* ... */ }

            ~ReadWriteLock() { os::FinalizeReaderWriterLock(std::addressof(this->rw_lock)); }
